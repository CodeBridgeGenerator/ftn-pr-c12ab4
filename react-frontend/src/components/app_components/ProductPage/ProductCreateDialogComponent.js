...
const ProductCreateDialogComponent = (props) => {
    ...
    return (
        <Dialog header="Create Product" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
